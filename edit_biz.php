...
<html>
<head>
  <title>Edit Online Shop (Biz) | www.ecommercedirectorypk.com</title>
  <meta charset="utf-8">
...
<ol class="breadcrumb">
    ...
    <li class="active">Edit Biz</li>        
  </ol>
<?php include($pt."/includes/ad.php"); ?>
  <h1>Edit Your Online Business </h1>
  <p>&nbsp;</p>
  <div class="row">
<div class="col-sm-8">
...
<div class="page-header">
 ...
 $db =new DBSQLi();
		 $conn=$db->getCon();
		 $id=$_SESSION['id'];
		 $sql = "SELECT * FROM tbl_shop WHERE addedby=$id";
...
title="Seperate numbers by commas.">Note</button>
  ...
  <?php }else{
  echo "<h2 class='alert alert-danger'>You need to have Online Business to Edit.</h2>";
  }?>
	</p>
	</div>
</div>
