...
<html>
<head>
  <title>Donate to www.ecommercedirectorypk.com</title>
  <meta charset="utf-8">
  <?php include($pt."/includes/fav.php"); ?>
  <meta name="description" content="Help us! Donate Zakat and Funds to ecommercedirectrypk.com for further web and business development. You can also give gifts to us like laptop and ups etc....">
  <meta name="author" content="vitzwebtech"> 	
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="keywords" content="Help,Donations, Zakat and Funds, Gifts, Donate Zakat, Donate Funds..">
...
<?php include($pt."/includes/ad.php"); ?>
  ...
  <ul>
    <li>
      <h4>You can donate ecommercedirectorypk.com for further web and business development. </h4>
    </li>
    <li>We Have a UBL Ameen Account. You can pay through ny UBL Branch. </li>
    <li>Please contact to us with following information for donations/.</li>
  </ul>
