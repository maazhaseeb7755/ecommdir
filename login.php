...
$message .= "</div>";
$message .= " <p>&nbsp;</p><h3>Congratulations!</h3><br/><p> You have been Registered Successfully at www.ecommercedirectorypk.com.  </br> You can now add your business. enjoy your Day! </p>";
...
<div class="panel-body" style="padding:15px 15px 15px 15px;">
    ...
    <h1>Register! Create New Account Now </h1><a name="register"></a>
	 <div id="show">
	   <h4>WHO Needs AN Account!. A user does not need an account on ecommercedirectorypk.com unless he or she wnats to add a business or onlie shop in the directory. For creating New Account, the user's email address requires approval and then you will be allowed to add your business.<br>
	   </h4>
	 </div>
	 <span style="padding-top:10px; padding-bottom:10px; visibility:hidden">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;v&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
     <p>
	 <div id="rmsg"></div>
